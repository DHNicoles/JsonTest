...
int main()
{
	...
	//	{
	//		string key = arrayObj[i].begin().memberName();
	//		cout << key << ":" << arrayObj[i][key].asString() << endl;
	...
	Json::Reader reader;
	Json::Value res;
	reader.parse(str, res);
	cout << res.begin().memberName() << endl;
	cout << res[res.begin().memberName()].begin().memberName() << endl;
	cout << res[res.begin().memberName()][res[res.begin().memberName()].begin().memberName()].asString() << endl;
	return 0;
}
